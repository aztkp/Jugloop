    ...
    <div class="main">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 6, 1, 0) && $stamp->isDoneByCigar($me->id, 6, 2, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 6, 1, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="6">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_count_box text-success"><div id="trick_count">5回</div>
          ...
          <?php if($stamp->isDoneByCigar($me->id, 6, 2, 0) && $stamp->isDoneByCigar($me->id, 6, 3, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 6, 2, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="6">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 6, 3, 0) && $stamp->isDoneByCigar($me->id, 6, 4, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 6, 3, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="6">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 6, 4, 0) && $stamp->isDoneByCigar($me->id, 6, 5, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 6, 4, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="6">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 6, 5, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="6">
