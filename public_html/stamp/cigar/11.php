  ...
  <body>
    ...
    <div class="main">
      <ul class="breadcrumb">
        ...
        <li class="active">DiamondRoop</li>
      </ul>
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 11, 1, 0) && $stamp->isDoneByCigar($me->id, 11, 2, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 11, 1, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="11">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_count_box text-success"><div id="trick_count">5回</div>
          ...
          <?php if($stamp->isDoneByCigar($me->id, 11, 2, 0) && $stamp->isDoneByCigar($me->id, 11, 3, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 11, 2, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="11">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 11, 3, 0) && $stamp->isDoneByCigar($me->id, 11, 4, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 11, 3, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="11">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 11, 4, 0) && $stamp->isDoneByCigar($me->id, 11, 5, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 11, 4, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="11">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 11, 5, 0) && $stamp->isDoneByCigar($me->id, 11, 6, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="11">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_count_box text-success"><div id="trick_count">3回</div></div>
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 11, 6, 0) && $stamp->isDoneByCigar($me->id, 11, 7, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="11">
          ...
          <?php elseif($stamp->isDoneByCigar($me->id, 11, 5, 0)): ?>
            <form action="update" method="post">
              <input type="hidden" name="trick_id" value="11">
              <input type="hidden" name="level" value="6">
              <input type="hidden" name="options" value="0">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_count_box text-success"><div id="trick_count">5回</div>
          ...
          <?php if($stamp->isDoneByCigar($me->id, 11, 7, 0) && $stamp->isDoneByCigar($me->id, 11, 8, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 11, 7, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="11">
          ...
          <?php elseif($stamp->isDoneByCigar($me->id, 11, 6, 0)): ?>
            <form action="update" method="post">
              <input type="hidden" name="trick_id" value="11">
              <input type="hidden" name="level" value="7">
              <input type="hidden" name="options" value="0">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_count_box text-success"><div id="trick_count">10回</div></div>
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 11, 8, 0) && $stamp->isDoneByCigar($me->id, 11, 9, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 11, 8, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="11">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_count_box text-success"><div id="trick_count">20回</div></div>
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 11, 9, 0) && $stamp->isDoneByCigar($me->id, 11, 10, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 11, 9, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="11">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_count_box text-success"><div id="trick_count">30回</div></div>
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 11, 10, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="11">
