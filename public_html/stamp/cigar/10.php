  ...
  <body>
    ...
    <div class="main">
      <ul class="breadcrumb">
        ...
        <li class="active">MillsMessChain</li>
      </ul>
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 10, 1, 0) && $stamp->isDoneByCigar($me->id, 10, 2, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 10, 1, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="10">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_count_box text-success"><div id="trick_count">5回</div>
          ...
          <?php if($stamp->isDoneByCigar($me->id, 10, 2, 0) && $stamp->isDoneByCigar($me->id, 10, 3, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 10, 2, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="10">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 10, 3, 0) && $stamp->isDoneByCigar($me->id, 10, 4, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 10, 3, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="10">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 10, 4, 0) && $stamp->isDoneByCigar($me->id, 10, 5, 0)): ?>
            <button class="btn btn-primary disabled">達成済
          <?php elseif($stamp->isDoneByCigar($me->id, 10, 4, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="10">
      ...
      <div class="panel panel-default trick_panel">
        ...
        <div class="trick_btn_box">
          <?php if($stamp->isDoneByCigar($me->id, 10, 5, 0)): ?>
            <form action="delete" method="post">
              <input type="hidden" name="trick_id" value="10">
